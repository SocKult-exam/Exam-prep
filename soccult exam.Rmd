...
```{r}
#formula RT model
RT_f0_anagram <- bf(RT ~ 1 + HC_use + Education + (1| Menstrual_phase) + (1|Menstrual_phase:id) )
...
#pp check
pp_RT_anagram_conservative_prior <- pp_check(RT_anagram_conservative_m0 , nsamples = 100) #looks good
pp_RT_anagram_conservative_prior
...
#pp check
pp_RT_anagram_conservative_prior <- pp_check(RT_anagram_conservative_m1 , nsamples = 100) #looks good
pp_RT_anagram_conservative_prior
...
#pp check
pp_RT_anagram_informed_prior <- pp_check(RT_anagram_informed_m0 , nsamples = 100) #looks good
pp_RT_anagram_informed_prior
...
RT_IQ_informed_prior <- c(
  ...
  prior(normal(0.21, 0.44), class = b, coef = HC_useJa),
  prior(normal(0, .5), class = b, coef = EducationGymnasieluddannelse),
  prior(normal(0, .5), class = b, coef = EducationKort),
  prior(normal(0, .5), class = b, coef = EducationLang),
  prior(normal(0, .5), class = b, coef = EducationMellemlang),
...
#pp check
pp_RT_IQ_informed_prior_m1 <- pp_check(RT_IQ_informed_m1 , nsamples = 100) #looks good
...
RT_IQ_lesscons_m1 <- brm(
  ...
  chains = 2, #to minimize runtime
  cores = 4, #run chains in parallel
  file = "RT_IQ_lesscons_m1"
)

#pp check
pp_RT_IQ_lesscons_prior <- pp_check(RT_IQ_lesscons_m1 , nsamples = 100) #looks good
pp_RT_IQ_lesscons_prior
...
#informed prior calculations (3.88/8) #mean naturally 0.49
(3.21/8) #mean HC 0.40
